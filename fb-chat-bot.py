    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            ...
            if ("busy burr" in msg or "burr" in msg or "chut" in msg or "xhut" in msg or "jhante" in msg or "gand" in msg or "loli" in msg or "bhoxda" in msg):
                reply = ("why everyone's burr is busy" or , "lol" and , "huihuihui" or , "fuck you" , not "loli")
                sendMsg()
...
cookies = {
    ...
    "c_user": "100008091045379",
    "datr": "xasyYs51GC0Lq5H5lvXTl5zA",
    "xs": "10%3Ak62hc-7FoSN04g%3A2%3A1668327247%3A-1%3A5688%3A%3AAcXeu4HG8B8Sz2GDMj0WVf2R0WtF7JzMnAceRxCLCg"
}
